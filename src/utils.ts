...
export const observeUnderlineVariables = observeStorage('underlineVariables', true)
export const setUnderlineVariables = (value: boolean) => setStorage('underlineVariables', value)
